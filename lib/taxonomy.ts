...
export const FILTER_ENUMS = {
  occasion: ["Everyday", "Office", "Bridal", "Party", "Lunar New Year"],
  color: ["Pink", "Nude", "Red", "White", "Black", "Blue", "Pastel", "Metallic"],
  ...
  detail: ["Rhinestones", "Charms", "3D flowers", "Foil/glitter", "Line art", "None"],
  accent_colors: [
    "Pink",
    "Nude",
    "Red",
